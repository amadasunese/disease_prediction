...
#         # Extract feature contributions (using SHAP or model coefficients)
#         if hasattr(model, "coef_"):
#             feature_importance = np.abs(model.coef_).flatten()  # Logistic Regression
#         elif hasattr(model, "feature_importances_"):
#             feature_importance = model.feature_importances_  # Tree-based models
#         else:
#             feature_importance = [0] * len(feature_labels)
...
#         # Render the template with results
#         return render_template("index.html", prediction_text=prediction_text, feature_contributions=feature_contributions)

#     except Exception as e:
#         return render_template("index.html", prediction_text="An error occurred during prediction.", feature_contributions=[0] * len(feature_labels))
